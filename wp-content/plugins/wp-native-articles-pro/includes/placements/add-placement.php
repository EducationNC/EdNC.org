...
<form id="wpna-add-placement" action="" method="POST">
	...
	<?php do_action( 'wpna_add_placement_form_top' ); ?>
	...
	<table class="form-table">
		<tbody>
			...
			<tr>
				...
				<td>
					<input name="name" required="required" id="wpna-placement-name" class="regular-text" type="text" value="" />
				...
				<td>
					<div id="wpna-placement-content-type">
						...
						<div id="wpna-placement-embed" class="wpna-placement-embed hidden">
							<label>
								<input id="wpna-placement-embed" placeholder="<?php esc_html_e( 'Embed URL', 'wp-native-articles' ); ?>" type="text" name="video_url" class="regular-text" value="" />
								<p class="description">
					...
					<div id="wpna-placement-position-paragraph-wrap">
						...
						<div id="wpna-placement-position-paragraph-form" class="hidden">
							...
							<label>
								...
								<input type="number" name="position_paragraph" id="wpna-placement-position-paragraph" class="wpna-placement-position" value="0" min="0" step="0" />
							</label>
							<hr />
						</div>
					</div>
					...
					<div id="wpna-placement-position-words-wrap">
						...
						<div id="wpna-placement-position-words-form" class="hidden">
							...
							<label>
								...
								<input type="number" name="position_words" id="wpna-placement-position-words" class="wpna-placement-position" value="150" min="0" step="0" />
							</label>
							<hr />
						</div>
					</div>
				...
				<td>
					...
					<div class="wpna-placement-filter-author-wrap">
						...
						<div id="wpna-placement-filter-custom-form" class="hidden">
							...
							<input type="text" name="filter_custom" class="regular-text" placeholder="e.g. post_type=movie&amp;tag_slug__in=action" value="" />
			...
			<tr>
				...
				<td>
					<input type="date" id="wpna-placement-start-date" name="start_date" value="<?php echo esc_attr( date( 'Y-m-d' ) ); ?>" />
					<p class="description">
						<?php printf(
			...
			<tr>
				...
				<td>
					<input type="date" id="wpna-placement-end-date" name="end_date" value="" min="<?php echo esc_attr( date( 'Y-m-d' ) ); ?>" />
					<p class="description">
						<?php printf(
							// translators: Placeholder is the example date format.
	...
	<p class="submit">
		<input type="hidden" name="wpna-action" value="add_placement" />
		...
		<input type="submit" name="submit" value="<?php esc_html_e( 'Add Placement', 'wp-native-articles' ); ?>" class="button-primary" />
	</p>
