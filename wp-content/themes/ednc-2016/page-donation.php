...
<?php while (have_posts()) : the_post(); ?>
  <div class="container">
    <div class="row donate">
      <div class="col-md-6 donate-content">
        <h1>Invest in EdNC’s work today.</h1>
        <iframe src="https://player.vimeo.com/video/281859270" width="500" height="281" frameborder="0" allowfullscreen>
        </iframe>
        <p>As a nonprofit organization, we rely on the support of people just
      ...
      <div class="col-md-6 donate-iframe">
        ...
        style="max-width:500px; min-width:310px; max-height:none!important" seamless="seamless" name="donorbox"
