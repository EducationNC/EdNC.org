...
// old $crunchifyTitle = urlencode(get_the_title($id));
$crunchifyTitle = html_entity_decode(get_the_title($id));
...
if ($counts === false) {
  ...
  //set_transient('social-counts-' . $id, $counts, MINUTE_IN_SECONDS  );
}
