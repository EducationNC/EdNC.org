...
class Reach_NC_Polls extends \WP_Widget {
    ...
    parent::__construct(
			'reach_nc_polls', // Base ID
			__( 'Reach NC Polls', 'sage' ), // Name
	...
	public function widget( $args, $instance ) {
		...
		include(locate_template('templates/widgets/reach-nc-polls.php'));
	...
	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) || isset( $instance[ 'msg' ] ) || isset( $instance[ 'bg_url' ] ) ) {
			...
			$title = __( 'New title', 'reach_nc_polls' );
			$msg = __( 'New Message', 'reach_nc_polls' );
			$bg_url = __( 'New Background Url', 'reach_nc_polls' );
		}
			// Widget admin form
		?>
			<p>
