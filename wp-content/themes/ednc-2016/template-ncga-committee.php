  ...
  <div class="container ncga">
    ...
    <div class="row">
            ...
            if ($leaders->have_posts()) : while ($leaders->have_posts()) : $leaders->the_post(); ?>
              ...
              <div class="col-xs-6 col-sm-3 block-person">
                <div class="position-relative">
                  ...
                  <div class="overflow-hidden"><?php the_post_thumbnail('bio-headshot-committee'); ?></div>
                  <h4 class="post-title"><?php the_title(); ?>,<br /><?php the_field($meta_key); ?></h4>
                </div>
              </div>

            <?php endwhile; endif; wp_reset_query(); remove_filter( 'posts_orderby' , 'posts_orderby_lastname' ); ?>
          <?php endforeach; ?>
        </div>
      ...
      <div class="col-md-3 col-lg-push-1">
        <div class="callout">
          <h3>2017-19 NCGA Education Committees</h3>
