...
class WPNA_Activator {
	...
	public static function run_database_scripts() {
		...
		// Placements table. Added 1.3.0.
		$scripts[] = 'CREATE TABLE ' . $wpdb->base_prefix . "wpna_placements (
		...
		// Placements Meta table. Added 1.3.0.
		$scripts[] = 'CREATE TABLE ' . $wpdb->base_prefix . "wpna_placements_meta (
