 ...
 * @author Naitik Shah <naitik@facebook.com>
 */
abstract class WPNA_BaseFacebook
{
  /**
   * Version.
   */
  ...
  public function setExtendedAccessToken() {
    ...
    $json_decode = json_decode($access_token_response);

    if ( $json_decode !== FALSE ) {
      if ( property_exists( $json_decode, 'error' ) ) {
        $error = new WP_Error( 'wpna_facebook_api_extended_access_token_error', $json_decode->error->message );
  ...
  protected function getAccessTokenFromCode($code, $redirect_uri = null) {
    ...
    if ( $json_decode !== FALSE ) {
      if ( property_exists( $json_decode, 'error' ) ) {
          $error = new WP_Error( 'wpna_facebook_api_access_token_error', $json_decode->error->message );
          wpna_add_facebook_notification( $error );
          return false;
      } else {
        return $json_decode->access_token;
